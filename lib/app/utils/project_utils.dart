...
List<ProjectUtils> projectUtils = [
  ...
  ProjectUtils(
    ...
    titles: 'AKGEC APP',
    description:
        'Its an app in which student of akgec can join their respective classrooms, respective subject google meet and can share study material , source code is also available, check below.',
    links: 'https://github.com/Dipendra-Raghav/AKGEC-APP',
  ),
];
